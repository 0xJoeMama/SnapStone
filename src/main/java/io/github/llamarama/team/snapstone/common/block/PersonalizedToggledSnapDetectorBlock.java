...
public class PersonalizedToggledSnapDetectorBlock extends ToggledSnapDetectorBlock implements BlockEntityProvider {

    public PersonalizedToggledSnapDetectorBlock(Settings settings) {
        super(settings);
    }
