...
public class PersonalToggledSnapDetectorBlock extends ToggledSnapDetectorBlock implements BlockEntityProvider {

    public PersonalToggledSnapDetectorBlock(Settings settings) {
        super(settings);
    }
